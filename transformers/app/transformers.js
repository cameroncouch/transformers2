const Transformer = (name, title, type1, type2, type3, sword, wrench, shield, star, allegiance, mode, wave, cardno, rarity) => {
    ...
    const bumblebeeSt = Transformer('Bumblebee (T)', 'Brave Warrior', 'Leader', '2none', 'Melee', 4, 9, 2, 6, 'Autobot', 'Alt', '1', 'ST01', 'Rare');
    ...
    const optimusprimeSt = Transformer('Optimus Prime (T)', 'Autobot Leader', 'Leader', '2none', 'Ranged', 3, 10, 2, 7, 'Autobot', 'Alt', '1S', 'ST03', 'Rare');
    ...
    const sludgew2 = Transformer('Sludge', 'Dino Demolitions', '1none', 'Dinobot', 'Melee', 3, 12, 2, 8, 'Autobot', 'Alt', '2', 'T18', 'Rare' );
    const slugw2 = Transformer('Slug', 'Battering Ram', '1none', 'Dinobot', 'Melee', 3, 10, 3, 8, 'Autobot', 'Alt', '2', 'T19', 'Rare' );
    const snarlw2 = Transformer('Snarl', 'Spiked Battler', '1none', 'Dinobot', 'Melee', 3, 9, 2, 7, 'Autobot', 'Alt', '2', 'T20', 'Rare' );
    const swoopw2 = Transformer('Swoop', 'Bombardier', '1none', 'Dinobot', 'Specialist', 3, 11, 1, 7, 'Autobot', 'Alt', '2', 'T21', 'Rare' );
    ...
    const headstrongw2 = Transformer('Headstrong', 'Ground Assault', '1none', 'Predacon', 'Melee', 1, 5, 3, 5, 'Decepticon', 'Alt', '2', 'T33', 'Uncommon' );
    const rampagew2 = Transformer('Rampage', 'Savage Hunter', '1none', 'Predacon', 'Melee', 2, 7, 1, 5, 'Decepticon', 'Alt', '2', 'T34', 'Uncommon' );
    ...
    const windbladeRw2 = Transformer('Windblade (R)', 'Defender of Truth', '1none', 'Plane', 'Ranged', 2, 8, 1, 5, 'Autobot', 'Alt', '2', 'T04', 'Rare' );
